...
public class PersistentDataDAOImpl implements PersistentDataDAO{

    public PersistentDataDAOImpl(){
    }
    ...
    public Statistics getStatistics(){
        ...
        try{
            ...
            if(con.isClosed()){con = ConnectionFactory.getConnection();}
            getStats = con.prepareStatement(getStatsSQL);
